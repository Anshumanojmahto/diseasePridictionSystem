# -*- coding: utf-8 -*-
"""
Created on Sat Aug  2 12:28:01 2025
...
diebeties_model  =  pickle.load(open("diabetic_model.sav",'rb'))
heart_model =  pickle.load(open("heartdisease_model.sav",'rb'))
parkinsons_model = pickle.load(open("parkinsons_model.sav",'rb'))


with st.sidebar:
    selected = option_menu('Disease Pridiction System',
                          ['Diabetes Prediction',
...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('Show Test Result'):
        diab_prediction = diebeties_model.predict([[Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age]])
